  ...
  return (
    <>
      ...
      >
        ...
        <div className="bg-black text-white p-6 pb-8 rounded-br-[3rem]">
          <div className="flex items-center gap-4 mt-4">
            ...
            <div>
              ...
              {/* FIX: Shows ONLY 'Admin' if they are an admin */}
        ...
        {/* Earnings Widget UI (Drivers Only) */}
        {!authUser.isAdmin && authUser?.activeRole === 'driver' && (
        ...
        <div className="flex flex-col p-4 space-y-2 mt-2">
          ...
          {/* FIX: Hide Map, History, and Driver tools if they are an Admin */}
          {!authUser.isAdmin && (
            <>
              <button 
          ...
          {/* PROFILE BUTTON (Visible to everyone) */}
          <button 
